...
// --- LEVEL 1: FOUNDATION (المجند) ---
const L1_UNITS = [
  {
    title: '1. مدخل إلى الأمن السيبراني',
    description: 'المفاهيم الأساسية، CIA Triad، ولماذا نحمي البيانات.',
    lessons: [
      'ما هو الأمن السيبراني؟',
      'مثلث الحماية (CIA Triad)',
      'الفرق بين الخطر والتهديد والثغرة',
      'أهمية البيانات في العصر الرقمي',
      'تاريخ الفيروسات والقرصنة',
      'المصطلحات الأمنية الأساسية',
      'قوانين الجرائم الإلكترونية (نظرة عامة)',
      'المسار المهني في الأمن السيبراني'
    ]
  },
  {
    title: '2. قراصنة الإنترنت (Hackers)',
    description: 'من هم؟ كيف يفكرون؟ وما هي دوافعهم؟',
    lessons: [
      'القبعات البيضاء (Ethical Hackers)',
      'القبعات السوداء (Black Hat)',
      'القبعات الرمادية (Grey Hat)',
      'دوافع المخترقين (المال، الشهرة، التخريب)',
      'مجموعات التهديد المتقدمة (APTs)',
      'أطفال السكربتات (Script Kiddies)',
      'الهاكتفيزم (Hacktivism)',
      'كيف يفكر المخترق؟'
    ]
  },
  {
    title: '3. البرمجيات الخبيثة (Malware)',
    description: 'دراسة أنواع الأكواد الضارة وكيفية انتشارها.',
    lessons: [
      'تعريف البرمجيات الخبيثة',
      'الفيروسات (Viruses) وكيف تنتقل',
      'الديدان الإلكترونية (Worms)',
      'أحصنة طروادة (Trojans)',
      'برامج الفدية (Ransomware)',
      'برامج التجسس (Spyware)',
      'الجذور الخفية (Rootkits)',
      'كيف تكتشف إصابة جهازك؟'
    ]
  },
  {
    title: '4. الهندسة الاجتماعية',
    description: 'اختراق العقول البشرية بدلاً من الأنظمة.',
    lessons: [
  ...
  {
    title: '5. أمن الشبكات (أساسيات)',
    description: 'كيف تنتقل البيانات وكيف نحمي طريقها.',
    lessons: [
      'ما هي الشبكة؟ (LAN vs WAN)',
      'عنوان الإنترنت (IP Address)',
      'نظام أسماء النطاقات (DNS)',
      'الجدار الناري (Firewall) ببساطة',
      'الشبكات الافتراضية الخاصة (VPN)',
      'مخاطر شبكات Wi-Fi العامة',
      'تشفير الاتصال',
      'بروتوكولات الإنترنت الأساسية'
    ]
  },
  {
    title: '6. أمن أنظمة التشغيل',
    description: 'حماية Windows و Linux والهواتف.',
    lessons: [
      'أهمية التحديثات الأمنية (Patching)',
      'حسابات المستخدمين والصلاحيات',
      'مضادات الفيروسات (Antivirus)',
      'أمن ويندوز (Windows Security)',
      'مقدمة في أمان لينكس',
      'أمن الهواتف الذكية (Android/iOS)',
      'النسخ الاحتياطي (Backups)',
      'تشفير القرص الصلب'
    ]
  },
  {
    title: '7. أمان التصفح والويب',
    description: 'كيف تبقى آمناً أثناء تصفح الإنترنت.',
    lessons: [
      'بروتوكول HTTPS والقفل الأخضر',
      'ملفات تعريف الارتباط (Cookies)',
      'إدارة كلمات المرور (Password Managers)',
      'المصادقة الثنائية (2FA)',
      'مخاطر الإضافات (Browser Extensions)',
  ...
  {
    title: '8. التشفير (Cryptography 101)',
    description: 'علم إخفاء البيانات عن المتطفلين.',
    lessons: [
      'ما هو التشفير؟',
      'التشفير التقليدي vs الحديث',
      'المفتاح العام والخاص (ببساطة)',
      'التجزئة (Hashing) والفرق عن التشفير',
  ...
  {
    title: '9. الخصوصية الرقمية',
    description: 'حماية هويتك وبياناتك الشخصية.',
    lessons: [
      'ما هي البصمة الرقمية؟',
      'إعدادات الخصوصية في التواصل الاجتماعي',
      'جمع البيانات من الشركات الكبرى',
      'قوانين حماية البيانات (GDPR)',
  ...
  {
    title: '10. السيناريوهات الدفاعية',
    description: 'تطبيق عملي لما تعلمته في مواقف حقيقية.',
    lessons: [
      ...
      'العمل عن بعد بأمان',
      'مراجعة شاملة للمستوى الأول',
      'التحضير للمستوى الثاني'
    ]
  }
];
